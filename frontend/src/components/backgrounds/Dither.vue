<!--
  Adapted from Vue Bits Dither:
  https://github.com/DavidHDev/vue-bits/tree/main/src/content/Backgrounds/Dither
  Copyright (c) 2025 David Haz. See LICENSE.vue-bits.md.
-->
<template>
  <div ref="containerRef" class="dither-container" />
</template>
